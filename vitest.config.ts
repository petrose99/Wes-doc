...
export default defineConfig({
  test: {
    ...
    include: [
      ...
      // ADR 0005 step 3: the Nango webhook route is the one authoritative signal for a connection's
      // connected/needs_reconnect state, same shipped-boundary reasoning as inbound-email above.
      "app/api/webhooks/nango/**/*.test.ts",
