...
export function Intake() {
  return (
    <section id="intake" className="border-y border-slate-200 bg-white py-9 md:py-11">
      <div className="mx-auto max-w-6xl px-5">
        <div className="grid gap-6 md:grid-cols-2 md:gap-10">
          <div className="flex gap-3.5">
            <Upload aria-hidden className="mt-0.5 h-5 w-5 shrink-0 text-emerald-700" strokeWidth={2} />
            <div className="min-w-0">
              <h3 className="font-display text-[1.05rem] font-bold tracking-[-0.02em] text-slate-900">Drop in a file or a whole folder</h3>
              <p className="mt-1 text-pretty text-[0.9rem] leading-[1.55] text-slate-600">
          ...
          <div className="flex gap-3.5 md:border-l md:border-slate-200 md:pl-10">
            <Mail aria-hidden className="mt-0.5 h-5 w-5 shrink-0 text-emerald-700" strokeWidth={2} />
            <div className="min-w-0">
              <h3 className="font-display text-[1.05rem] font-bold tracking-[-0.02em] text-slate-900">Or email it to your workspace</h3>
              <p className="mt-1 text-pretty text-[0.9rem] leading-[1.55] text-slate-600">
                Forward a bill, or give the address to suppliers and let them arrive on their own. Only senders
                you allow get through.
              </p>
              <p className="mt-2 inline-flex max-w-full items-center rounded-md border border-slate-200 bg-white px-2.5 py-1">
                <span className={`break-words font-mono text-emerald-800 ${MOCK_TYPE.supporting}`}>acme-9f3c@inbound.docubite.app</span>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 border-t border-slate-200 pt-4">
          <p className="max-w-[29rem] text-pretty text-[0.86rem] leading-[1.55] text-slate-600">
