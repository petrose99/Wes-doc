...
const steps = [
  ...
  { n: "02", icon: Sparkles, title: "Extract", text: "Every PDF or image page is parsed to text, and a template says which fields matter." },
...
export function Workflow() {
  return (
    <section className="mx-auto max-w-6xl px-5 py-20">
      <Reveal>
        <h2 className="max-w-2xl font-display text-4xl font-bold tracking-[-0.035em] text-slate-950 sm:text-5xl">
      ...
      <div className="relative mt-16">
        ...
        <div className="absolute left-[1.15rem] top-2 h-[calc(100%-1rem)] w-px bg-slate-200 lg:hidden" aria-hidden />
        <div className="perforation absolute inset-x-0 top-5 hidden text-slate-300 lg:block" aria-hidden />
            ...
            <Reveal key={step.n} delay={0.1 * index}>
              <article className="relative flex gap-5 pl-2 lg:block lg:pl-0">
                ...
                <div className="lg:pt-1">
                  ...
                  <h3 className="mt-4 font-display text-xl font-bold tracking-[-0.02em] text-slate-950">{step.title}</h3>
