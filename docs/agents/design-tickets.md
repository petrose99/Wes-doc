# Design tickets on a Wayfinder map

Moved out of `CLAUDE.md` on 2026-09-17 so that every session does not carry it; it applies in full whenever a Wayfinder ticket touches a user-facing surface. `CLAUDE.md` points here.
