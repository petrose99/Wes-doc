// Autopilot helper (#251): apply the additive Prisma schema edits. Idempotent-ish: asserts each anchor.
import { readFileSync, writeFileSync } from 'node:fs'
const p = '/home/ubuntu/Dev/Wes-doc/prisma/schema.prisma'
let s = readFileSync(p, 'utf8')
if (s.includes('model PayerAccount')) { console.log('already applied'); process.exit(0) }
