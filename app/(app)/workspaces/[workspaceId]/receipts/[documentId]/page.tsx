...
import { ReceiptsQueuePage } from "../../(queue)/receipts/page"
...
export default async function DeepLinkPage({ params, searchParams }: {
  ...
  if (query.full === "1") return DocumentDetailPage({ params, searchParams, queueTitle: "Receipts" })
  return ReceiptsQueuePage({ params: Promise.resolve({ workspaceId }), searchParams: Promise.resolve(query), selectedDocumentId: documentId })
}
