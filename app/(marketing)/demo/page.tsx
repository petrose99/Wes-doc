...
const points = [
  { icon: Sparkles, title: "We run your documents, not ours", text: "Bring it to the call: the invoice, receipt or handwritten note that everything else chokes on. Nothing to upload here — we put it through while you watch." },
  ...
  return (
    <section className="bg-cream-50">
      <div className="mx-auto grid max-w-6xl gap-12 px-5 py-16 lg:grid-cols-[1fr_.9fr] lg:py-20">
        <div>
          <p className="text-sm font-semibold uppercase tracking-[.16em] text-emerald-700">Request a demo</p>
